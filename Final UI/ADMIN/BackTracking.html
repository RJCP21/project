            ...
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item">
                      ...
                      <a class="nav-link active" href="#" style="margin: 0px;"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a></li>
                </ul>
                <!-- media -->
                ...
                <footer class="footer-basic" style="background: var(--bs-dark);height: 210px;">
                    <div class="social" style="background: var(--bs-dark);margin-bottom: 0px;margin-top: 8px;">
                      ...
                      <a href="#" style="background: var(--bs-white);"><i class="icon ion-social-facebook"></i></a></div>
                </footer>
