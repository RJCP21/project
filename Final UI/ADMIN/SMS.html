        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: var(--bs-purple);background: var(--bs-dark);margin: 0px;padding-right: 0px;margin-right: 0px;margin-top: 0px;margin-bottom: 0px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item">
                      <a class="nav-link active" href="#"><i class="fa fa-user"></i><span>Account</span></a>
                      <a class="nav-link active" href="#"><i class="fas fa-server"></i><span>List Of Server</span></a>
                      <a class="nav-link active" href="#"><i class="fas fa-chart-pie"></i><span>Analytics</span></a>
                      <a class="nav-link active" href="#"><i class="fas fa-qrcode"></i><span>QR</span></a>
                      <a class="nav-link active" href="#"><i class="fas fa-location-arrow"></i><span>BackTracking</span></a>
                      <a class="nav-link active" href="#" style="text-shadow: 0px 0px;"><i class="fas fa-sms"></i><span style="height: 0px;">SMS</span></a>
                      <a class="nav-link active" href="#" style="margin: 0px;"><i class="fas fa-bug"></i><span>Report</span></a>
                      <a class="nav-link active" href="#" style="margin: 0px;"><i class="fas fa-sign-out-alt"></i><span>Logout</span>
                      </a>
                    </li>
                </ul>
                <!-- media -->
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container" style="margin:40px">
                    <p>Input Message</p>
                    <form>
                        <div class="form-group mb-3"><textarea class="form-control" id="summernote" name="editordata"></textarea></div>
                        <div class="form-group mb-3"><button class="btn btn-primary" type="submit">Send Message</button></div>
                    </form>
                </div>
            </div>
        </div>
